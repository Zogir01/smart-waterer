...
#define MIN_WATERING_TIME					100				// Minimalny
#define MAX_WATERING_TIME					10000			// Maksymalny czas podlewania

#define MIN_SAMPLE_COUNT					1				// Minimalna
#define MAX_SAMPLE_COUNT					10000			// Maksymalna ilość pomiarów wilgotności do uśrednienia

#define MIN_READ_DELAY 						50				// Minimalny
#define MAX_READ_DELAY 						10000			// Maksymalny czas w ms pomiędzy pomiarami wilgotności

#define MIN_DRY_THRESHOLD					1				// Minimalny
#define MAX_DRY_THRESHOLD 					99				// Maksymalny próg wilgotności dla którego podlewać
